...
(* OASIS_START *)
(* DO NOT EDIT (digest: c5ed90670abde9290655227ce2227cc3) *)
(*
...
let setup_t =
  {
          ...
          build_custom =
            {
               pre_command = [(OASISExpr.EBool true, None)];
               post_command =
                 [(OASISExpr.EBool true, Some (("./gen_xen.sh", ["main"])))];
               };
     ...
     oasis_version = "0.3.1";
     oasis_digest =
       Some "U\155\219\182\128\245Q\162\243\230\014u\232\189K\223";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
